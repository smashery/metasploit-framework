    ...
    module Kerberos
      module Model
        ...
        class EtypeInfo2Entry < Element
          ...
          # Decodes the Rex::Proto::Kerberos::Model::EtypeInfo2Entry from an input
          #
          ...
          # Decodes a Rex::Proto::Kerberos::Model::EtypeInfo2Entry from an String
          #
          ...
          # Decodes a Rex::Proto::Kerberos::Model::EtypeInfo2Entry
          #
          ...
          def decode_asn1(input)
            input.value.each do |val|
              ...
              when 2
                self.s2kparms = decode_s2kparms(val)
              else
