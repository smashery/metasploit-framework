  ...
  module Proto
    module Kerberos
      module Model
        ...
        class EtypeInfo2 < Element
          # @!attribute etype_info2_entries
          #   @return [Array<Rex::Proto::Kerberos::Model>] The list of all etype_info entries
          attr_accessor :etype_info2_entries

          # Decodes the Rex::Proto::Kerberos::Model::EtypeInfo2 from an input
          #
          ...
          # Decodes a Rex::Proto::Kerberos::Model::EtypeInfo2 from an String
          #
          ...
          # Decodes a Rex::Proto::Kerberos::Model::EtypeInfo2
          #
          ...
          def decode_etype_entries(input)
            ...
            input.value.each do |val|
              entries.append(Rex::Proto::Kerberos::Model::EtypeInfo2Entry.decode(val))         
            end
            entries
          end
        end
